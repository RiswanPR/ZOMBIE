...
function preload() {
  ground_image = loadImage("https://wallup.net/wp-content/uploads/2018/10/01/804698-dark-evil-horror-spooky-creepy-scary-748x468.jpg");
  girl_running = loadAnimation("Run (1).png", "Run (2).png", "Run (3).png");
  zombie_running = loadAnimation("Walk (1).png", "Walk (2).png", "Walk (3).png",
                                 "Walk (4).png", "Walk (5).png", "Walk (6).png",
                                  "Walk (7).png", "Walk (8).png", "Walk (9).png",
                                   "Walk (10).png");

  zombie_attack = loadAnimation("Attack (2).png", "Attack (3).png", "Attack (4).png", 
                               "Attack (5).png", "Attack (6).png", "Attack (7).png", "Attack (8).png");
...
function setup() {
  ...
  restart.addImage(restartImage);
   ...
   A2= createSprite(300, 60);
  A2.addImage(A1);
  A2.scale = 0.4
  A2.visible = false;

  B2= createSprite(300, 60);
  B2.addImage(B1);
  B2.scale = 0.4
  B2.visible = false;
